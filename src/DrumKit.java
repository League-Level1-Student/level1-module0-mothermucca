...
public class DrumKit extends MouseAdapter {
    ...
    private void getGoing() throws MalformedURLException {
   	 ...
   	 // 4. Set the title of the frame
   	 	jframe.setTitle("This is the title");
   	 ...
   	 // 8. Put the name of your image in a String variable.
   	 	...
   	 	String cymbalImageString = "cymbal.jpg";
    
   	 // 9. Edit the next line to use your String variable
   	 	drumLabelWithImage = createLabelImage(drumImageString);
   	 	cymbalLabelWithImage = createLabelImage(cymbalImageString);
   	 
   	 // 10. Add the image to the panel
   	 	jpanel.add(drumLabelWithImage);
   	 	jpanel.add(cymbalLabelWithImage);
    ...
    public void mouseClicked(MouseEvent e) {
   	 ...
   	 JLabel imageClicked = (JLabel) e.getSource();
   	 ...
   	 if (imageClicked == drumLabelWithImage) {
   		 // 17. ...use the playSound method to play a drum sound.
   		 playSound("drum.wav");
   	 } else if (imageClicked == cymbalLabelWithImage) {
